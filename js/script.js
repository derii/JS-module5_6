...
var watch = new Stopwatch(clockDigits, startStopBtn);
...
function Stopwatch(elem, toogleBtn) {
  ...
  this.split = function (stopOrSplit) {
    if (this.isOn) {
      ...
      newElement.className = 'splitDigits col-md-6 col-md-offset-3 col-sm-12 col-xs-12';
  ...
  function removeSplitElements() {
    var splitElem = document.querySelectorAll('.splitDigits');
    var parent = document.body.querySelector('.wrapper');
